...
// Genera un terreno a partir de un heightmap procedural
...
// Obtiene altura del terreno en una posición x,z según el heightmap
float GetHeightAtPoint(Image heightmap, int x, int z, float maxHeight) {
  if (x < 0) x = 0;
    ...
    // El heightmap es en escala de grises, usamos canal rojo (o cualquiera)
